...
import { IUserDocument, ETradingInitiator, BotTradingDto } from "@torobot/shared"
...
export class BotController {
  ...
  @Get('/all/:initiator')
  getAll(@Param('initiator') initiator: ETradingInitiator) {
    return this.botService.getAll(initiator);
  }
  ...
  async create(@Body() payload: BotDto, @CurrentUser() user: IUserDocument) {
    ...
    return this.botService.create(botDto as any, user);
  }
