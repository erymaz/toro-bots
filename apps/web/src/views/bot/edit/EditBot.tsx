...
export const EditBot = (props: Props) => {
  ...
  const { bot, visible, setVisible, isEdit } = props;
    ...
    >
      ...
      >
        <Row gutter={20}>
          ...
          <Col span={8}>
            <Card
              title={<span className='text-green-dark'>Buying and Selling Settings</span>}
          ...
          <Col span={8}>
            ...
            >
              <div className='flex'>
                <div className='ant-col-8 text-right mt-1 pr-2'>Stop Loss[%]:</div>
              ...
              <div className='flex'>
                <div className='ant-col-8 text-right mt-1 pr-2'>Savings[%]:</div>
                <div className='flex ant-col-16'>
                  <Form.Item >
                    <Checkbox 
                      className='mr-3'
