...
import { BOT_LOAD_ALL, BOT_LOAD_MY, BOT_LOAD_BY_ID, BOT_ADD, BOT_DELETE, BOT_UPDATE, BOT_START, BOT_STOP, BOT_LOAD_STATUSES, BOT_ARCHIVE } from '../action-types';
import errorHandler from '../error-handler';
import { botService } from '../../services';
import { IBotUpdateRequest, IBotAddRequest, IBotTradingRequest } from '../../types';
